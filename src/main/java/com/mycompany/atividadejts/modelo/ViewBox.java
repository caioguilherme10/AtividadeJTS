...
public class ViewBox {
    ...
    public String getViewBox(Geometry geom1, Geometry geom2){
    ...
    public double getXMin(Geometry envelope){
    ...
    public double getYMin(Geometry envelope){
        Coordinate coordenadas[] = envelope.getCoordinates();
    ...
    public double getXMax(Geometry envelope){
        Coordinate coordenadas[] = envelope.getCoordinates();
    ...
    public double getYMax(Geometry envelope){
        Coordinate coordenadas[] = envelope.getCoordinates();
